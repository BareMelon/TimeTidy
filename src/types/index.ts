...
export interface PayrollCondition {
  field: 'time' | 'day_of_week' | 'location' | 'role'
  operator: 'equals' | 'greater_than' | 'less_than' | 'in'
  value: string | number | string[]
}

export interface UserPayrollAddOn {
  id: string
  userId: string
  addOnId: string
  isActive: boolean
...
export interface PayrollEntry {
  ...
  user?: User
  addOnBreakdown?: PayrollAddOnBreakdown[]
}

export interface PayrollAddOnBreakdown {
  id: string
  entryId: string
  addOnId: string
  amount: number
